<?php namespace Tusbol\LanguageSwitcherPlugin\LanguageSwitcher\Command;
...
class RenderLanguageSwitcher
{
    ...
    )
    {
        ...
        $composer_folder = base_path() . '/core/tusbol/language_switcher-plugin/resources/views'; // The location of the views if the user installed the plugin using composer
        $manual_folder = base_path() . '/addons/' . env('APPLICATION_REFERENCE') . '/tusbol/language_switcher-plugin/resources/views'; // The location of the views if the user installed the plugin manually
        $published_folder = base_path() . '/resources' . env('APPLICATION_REFERENCE') . 'addons/tusbol/language_switcher-plugin/views'; // The locations of the views if the user published the views
        ...
        return view("tusbol.plugin.language_switcher::$this->type", $data);
    }
}